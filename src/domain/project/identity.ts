...
export const ContentRecordRevisionIdSchema = z.uuid().brand<'ContentRecordRevisionId'>()
...
export type ContentRecordRevisionId = z.infer<typeof ContentRecordRevisionIdSchema>
...
export function parseDocumentId(value: unknown): DocumentId { return DocumentIdSchema.parse(value) }
export function parseNodeId(value: unknown): NodeId { return NodeIdSchema.parse(value) }
export function parseBreakpointId(value: unknown): BreakpointId { return BreakpointIdSchema.parse(value) }
export function parseGlobalComponentId(value: unknown): GlobalComponentId { return GlobalComponentIdSchema.parse(value) }
export function parseContentTypeId(value: unknown): ContentTypeId { return ContentTypeIdSchema.parse(value) }
export function parseTaxonomyId(value: unknown): TaxonomyId { return TaxonomyIdSchema.parse(value) }
export function parseTaxonomyTermId(value: unknown): TaxonomyTermId { return TaxonomyTermIdSchema.parse(value) }
export function parseFieldDefinitionId(value: unknown): FieldDefinitionId { return FieldDefinitionIdSchema.parse(value) }
export function parseContentRecordId(value: unknown): ContentRecordId { return ContentRecordIdSchema.parse(value) }
export function parseContentRecordRevisionId(value: unknown): ContentRecordRevisionId { return ContentRecordRevisionIdSchema.parse(value) }
export function parseRelationId(value: unknown): RelationId { return RelationIdSchema.parse(value) }
export function parseRelationEntryId(value: unknown): RelationEntryId { return RelationEntryIdSchema.parse(value) }
export function parseQueryId(value: unknown): QueryId { return QueryIdSchema.parse(value) }
export function parseFormId(value: unknown): FormId { return FormIdSchema.parse(value) }
export function parseRoleId(value: unknown): RoleId { return RoleIdSchema.parse(value) }
export function parseUserId(value: unknown): UserId { return UserIdSchema.parse(value) }
export function parseMenuId(value: unknown): MenuId { return MenuIdSchema.parse(value) }
export function parseMenuItemId(value: unknown): MenuItemId { return MenuItemIdSchema.parse(value) }
