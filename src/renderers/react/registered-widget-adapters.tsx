...
const adapters: Readonly<Record<string, RegisteredWidgetAdapter>> = {
  ...
  'react.media.video': (props) => <WidgetMediaPlayer kind="video" label={stringValue(props.properties, 'caption')} showControls={booleanValue(props.properties, 'controls', true)} source={safeMediaSource(stringValue(props.properties, 'src'))} />,
  'react.media.audio': (props) => <WidgetMediaPlayer kind="audio" label={stringValue(props.properties, 'label')} showControls={booleanValue(props.properties, 'controls', true)} source={safeMediaSource(stringValue(props.properties, 'src'))} />,
