...
export function BackendAdminWorkspace() {
  ...
  const visibleScreens = useMemo(() => {
    ...
    return activeUserId ? screens.filter((screen) => canAccessScreen(cms, activeUserId, screen.id)) : []
